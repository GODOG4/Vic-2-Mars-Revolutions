...
diplomacy = {
	...
	BASE_TRUCE_MONTHS = 0,
	MAX_INFLUENCE = 100,
	WARSUBSIDIES_PERCENT = 0.5, -- How many percent of imports you are going to pay each day(mil. constructions and mil. maintainence)
...
pops = {
	...
	INVENTION_IMPACT_ON_DEMAND = 0.006, -- how much each invention in a country increases demand for a product in percent
