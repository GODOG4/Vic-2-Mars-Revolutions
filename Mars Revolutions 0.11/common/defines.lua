...
country = {
	...
	MIN_CRIMEFIGHT_PERCENT = 0.0,
	MAX_CRIMEFIGHT_PERCENT = 0.0,
	ADMIN_EFFICIENCY_CRIMEFIGHT_PERCENT = 0.0, -- Crimefight depends on both state admin eff. and admin spending, admin spending percent effect is set to (1-ADMIN_EFFICIENCY_CRIMEFIGHT_PERCENT)
...
economy = {
	...
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 2000000,
	...
	MIN_NUM_FACTORIES_PER_STATE_BEFORE_DELETING_LASSIEZ_FAIRE = 4, -- Min number of factories per state before starting to delete under Lassiez Faire
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 1,	-- how fast pops are Hired when there is a high demand
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 1,	-- how fast pops are Hired when there is a medium demand
	RGO_SUPPLY_DEMAND_FACTOR_FIRE = 0.0,		-- how fast pops are Fired when there is a low demand
	EMPLOYMENT_HIRE_LOWEST = 0.005,				-- we Hire pops no slower then x% of total required per day
	EMPLOYMENT_FIRE_LOWEST = 0.000,				-- we Fire pops no slower then x% of total required per day
...
diplomacy = {
	...
	BASE_TRUCE_MONTHS = 0,
	MAX_INFLUENCE = 100,
	WARSUBSIDIES_PERCENT = 0.34, -- How many percent of imports you are going to pay each day(mil. constructions and mil. maintainence)
